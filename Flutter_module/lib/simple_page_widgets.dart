...
class FirstRouteWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: RaisedButton(
          child: Text('Open second22222222 route'),
          onPressed: () {
...
class FlutterRouteWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('flutter_boost_examp呜呜呜呜呜呜呜呜le'),
      ),
      body: Column(
        ...
        children: <Widget>[
          ...
          InkWell(
            child: Container(
                ...
                color: Colors.yellow,
                child: Text(
                  'open flutter fragment pag呜呜呜呜呜呜呜e',
                  style: TextStyle(fontSize: 22.0, color: Colors.black),
                )),
